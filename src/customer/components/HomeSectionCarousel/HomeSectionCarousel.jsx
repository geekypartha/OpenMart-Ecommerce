  ...
  return (
    <div className="border">
      <div className="relative p-5 ">
        <h2 className="text-3xl text-zinc-950 text-center font-jost-medium">{sectionName}</h2>
        <h3 className="text-gray-500 italic text-center py-2 font-jost-light ">{smallsection}</h3>
        <AliceCarousel
          items={items}
